...
const navLinks = [
    ...
    { href: '/products', label: 'OUR VARIETIES' },
...
export default function Header() {
    ...
    const headerBg = useTransform(
        scrollYProgress,
        [0, 0.25, 0.45, 0.75, 1],
        ['rgba(13, 167, 214, 0)', 'rgba(243, 214, 217, 0.8)', 'rgba(255, 244, 79, 0.8)', 'rgba(255, 215, 0, 0.8)', 'rgba(0, 51, 102, 0.8)']
    );
            ...
            <AnimatePresence>
                {mobileMenuOpen && (
                    <motion.div
                        ...
                        className="fixed top-0 left-0 w-full h-[100dvh] z-[9999] bg-brand-blue/80 backdrop-blur-md flex flex-col items-center justify-center p-8 overflow-y-auto"
                    >
                        {/* Closing Button */}
                        <button
